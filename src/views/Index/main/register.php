<main>
    <form action="./src/controllers/register" method="POST">
        <h2>Vous souhaiter créer un compte</h2>
        <label>
            <span>Email</span>
            <input type="email" name="email" required>
        </label>
        <small class="error"><?php if (isset($_GET["error-email"])) echo $_GET["error-email"]; ?></small>
